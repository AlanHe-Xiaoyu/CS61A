...
#       This implementation is also correct!
        self.card_power = self.attack - other_card.defense / 2
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        oppo_final = []
        for oppo_card in opponent.deck.cards:
            if oppo_card.attack != other_card.attack and oppo_card.defense != other_card.defense:
                oppo_final += oppo_card
        opponent.deck.cards = oppo_final
